...
const ProjectForm = () => {
  ...
  const { projectName, projectDescription, client, contractor, setProject } =
  ...
  const onSubmit = ({
    ...
    setProject({ projectName, projectDescription, client, contractor });
    navigate("/csv");
  };
    ...
    <Animator className="w-full max-w-2xl pl-2 pr-2 top-1/4 ">
      ...
      >
        ...
        <div className="w-full">
          ...
          />
          {errors.client && (
            <p className="text-red-600 mt-1 text-sm">client is required</p>
          )}
        </div>
        ...
        <div className="w-full">
          ...
          />
          {errors.contractor && (
            <p className="text-red-600 mt-1 text-sm">contractor is required</p>
          )}
        </div>
